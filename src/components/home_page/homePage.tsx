...
const categories = [
  {
    name: "Respiratory",
    image: "/categories/respiratory-system.jpg",
    linkRoute: `/medicine/categories/respiratory?q=respiratory`,
  },
  {
    name: "Digestive",
    image: "/categories/Digestive.jpg",
    linkRoute: "/medicine/categories/digestive?q=digestive",
  },
  {
    name: "Skin Care",
    image: "/categories/skin_care_1.jpg",
    linkRoute: "/medicine/categories/skin_care?q=skinCare",
  },
  {
    name: "Allergy",
    image: "/categories/Alergies.jpg",
    linkRoute: "/medicine/categories/allergy?q=allergy",
  },
  {
    name: "Pain Relief",
    image: "/categories/back_pain.jpg",
    linkRoute: "/medicine/categories/pain_relief?q=pain-relief",
  },
  {
    name: "Immunity Boosters",
    image: "/categories/immunity_booster.png",
    linkRoute: "/medicine/categories/immunity_booster?q=immunityBoosters",
  },
];
  ...
  return (
    <div className="">
      <div className=" mt-10 flex justify-center items-center">
        <div
          className={`${Style.textAnimation} relative overflow-hidden w-fit`}
        >
