...
const medicineData = new mongoose.Schema({
  ...
  medicinePotency: {
    type: String,
    ref: "medicinePotency",
    required: [true, "Medicine Potency is required"],
  },
  medicinePrice: {
    type: String,
    ref: "medicinePrice",
  ...
  recentDate: {
    type: String,
    ref: "recentDate",
    required: [true, " Recent Date is required"],
  },
  descriptions: {
    type: String,
    ref: "descriptions",
  ...
  sideEffect: {
    type: String,
    ref: "sideEffect",
    required: [true, "Side Effect is required"],
  },
  ...
  dilution: {
    type: String,
    ref: "dilution",
    required: [true, "Dilution  is required"],
  },
  likes: [],
  comments: [],
  image_public_id: {
...
export const allMedicines =
  mongoose.models.medicines || mongoose.model("medicines", medicineData);

const CartsData = new mongoose.Schema({
  medicineImage: { type: String, ref: "medicineImage", required: false },
  medicineId: { type: String, ref: "medicineId", required: false },
  userId: { type: String, ref: " userId", required: false },
